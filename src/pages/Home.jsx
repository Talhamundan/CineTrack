        ...
        <div className="flex flex-row justify-center items-center gap-3 w-full max-w-4xl mx-auto mb-6">
          <div className="relative flex-1">
            <input
              ...
              className="w-full bg-black/20 border border-white/10 rounded-xl px-3 py-2 md:pr-4 md:pl-11 md:py-3 pl-11 text-sm md:text-base text-white placeholder-gray-500 focus:border-red-600 focus:outline-none transition-colors"
            />
